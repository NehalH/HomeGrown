...
public class EditDetailsActivity extends AppCompatActivity {
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        if (documentSnapshot.exists()) {
                            // Populate the EditText fields with existing user details
    ...
    protected void onStart() {
        super.onStart();
        // Check and request the required permission for accessing external storage
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                // Permission denied, handle the case where the user doesn't grant permission
    ...
    private void loadImage() {
        // Load the image here
        // You can add your image loading logic here or call the method where you load the image from the imageUri
    }
        ...
        firestore.collection("users").document(userID)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        // If a new profile image is selected, upload it to Cloud Storage
                        if (imageUri != null) {
                            uploadImage(userID);
                        } else {
